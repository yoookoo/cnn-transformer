"""
Local Enhanced Feedforward in Vision Transformer
"""
...
@register_model
def leit_tiny_patch16_224(pretrained=False, **kwargs):
...
@register_model
def leit_small_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def leit_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def leit_small_patch16_384(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def leit_base_patch16_384(pretrained=False, **kwargs):
    model = VisionTransformer(
